...
book/Words_in_Swedenborg.pdf: book/Words_in_Swedenborg.adoc book/swedenborg-glossary.adoc book/front-matter.adoc book/publication-info.adoc book/back-matter.adoc book/cover.png book/new-words.adoc book/theological-words.adoc book/archaic-words.adoc book/version.adoc book/pdf-theme.yml
	asciidoctor-pdf -o $@ $<
...
# Build new-words.adoc, theological-words.adoc, and archaic-words.adoc from swedenborg-glossary.json
book/new-words.adoc book/theological-words.adoc book/archaic-words.adoc: swedenborg-glossary.json $(SRC_WORD_LISTS) $(SRC_GLOSSARY)
...
clean:
	...
	rm -f book/theological-words.adoc
	rm -f book/archaic-words.adoc
...
help:
	...
	@echo '  book/new-words.adoc book/theological-words.adoc book/archaic-words.adoc'
	...
	@echo ''
	@echo '  book/new-words.adoc, book/theological-words.adoc, and book/archaic-words.adoc depend on:'
	@echo '    - swedenborg-glossary.json'
	...
	@echo '    - book/theological-words.adoc'
	@echo '    - book/archaic-words.adoc'
	@echo '    - book/version.adoc'
